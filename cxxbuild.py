...
Usage:
    ...
    SEE ALSO cxxdeps.txt FILE:
       ...
       Catch2 == "v1.3.1" [ Catch2::Catch2WithMain ] git test https://github.com/catchorg/Catch2.git  special_catch_cmake_extras
       m
    """
    print(u)
        ...
        with open(root_path+'/cxxdeps.txt', 'r') as fd:
            ...
            for l in x:
                if (len(l) >= 1) and (l[0] != '#'):
                    ...
                    if len(fields) == 3:
                        # SYSTEM STATIC LIBRARY WITH VERSION! example: -lm=1.3.1
